...
nonisolated enum BroadcastAudio {
    ...
    static let appGroupID = "group.dev.nickel.Luma"
    ...
    static let preferredExtensionID = "dev.nickel.Luma.BroadcastExtension"
    ...
    nonisolated enum Notification {
        static let started = "dev.nickel.Luma.broadcast.started"
        static let finished = "dev.nickel.Luma.broadcast.finished"
        static let audio = "dev.nickel.Luma.broadcast.audio"
    }
}
