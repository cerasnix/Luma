...
- **Bundle ID**: `dev.nickel.Luma`
- **Target macOS**: 26.0+，Apple Silicon (arm64) only
- **Feedback Email**: ylxbf2@gmail.com
...
- Contact: <姓名> / ylxbf2@gmail.com / <电话>
...
1. [developer.apple.com](https://developer.apple.com/account) → Certificates, IDs &
   Profiles → Identifiers → 注册 App ID `dev.nickel.Luma`（capability 无需额外勾选，
